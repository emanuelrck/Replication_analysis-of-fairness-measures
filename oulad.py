...
if __name__ == '__main__':
    ...
    for i in seeds:
        ...
        for j in range(len(names_sens)):
            ...
            DIRETORIA_EXP = "exp_oulad_differentSplit_seed"+str(SEED)+"_"+str(SENSIVEL_NAME)+"_size"+str(SAMPLE_SIZE)
            ...
            dataset = pd.read_csv('data/ouladTransformed.data', sep=';', na_values=['?', ' ?'], header=0, names=features + [TARGET_NAME])
